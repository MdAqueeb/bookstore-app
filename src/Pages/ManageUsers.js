...
// import React, { useState, useEffect } from 'react';
// import { GetUsers, DeleteUser, AcceptRoleChangeRequest, RejectRoleChangeRequest } from './Controller/Apis';  // Assuming APIs to fetch, delete users, and handle role requests
...
//     try {
//       await AcceptRoleChangeRequest(userId); // Call API to accept the role change request
...
//     try {
//       await RejectRoleChangeRequest(userId); // Call API to reject the role change request
